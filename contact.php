        ...
        <div class="bgd1 container-fluid">
            ...
            <div class="row projektai">
                ...
                <div class="contact-form col-lg-6 col-md-6 col-xs-6 ">
                    <form name="myForm3" role="form" action="send_email.php" method="get">
                        ...
                        <textarea  class="textarea1" name="zinute" rows="8" cols="80" placeholder=" Jūsų žinutė" value="" required></textarea> <br>
