                ...
                <div class="col-6 proj-col-2 col-lg-6 col-md-6 col-xs-6 d-flex justify-content-center ">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            ...
                            <img class="d-block w-70 img-fluid" src="./img/kami-no-geemu/1.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">2 / 7</div>
                            <img class="d-block w-70 img-fluid" src="./img/kami-no-geemu/2.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">3 / 7</div>
                            <img class="d-block w-70 img-fluid" src="./img/kami-no-geemu/3.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">4 / 7</div>
                            <img class="d-block w-70 img-fluid" src="./img/kami-no-geemu/4.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">5 / 7</div>
                            <img class="d-block w-70 img-fluid" src="./img/kami-no-geemu/5.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">6 / 7</div>
                            <img class="d-block w-70 img-fluid" src="./img/kami-no-geemu/6.jpg">
                        </div>
                        <div class="carousel-item">
                            <div class="numbertext2">7 / 7</div>
                            <img class="d-block w-70 img-fluid" src="./img/kami-no-geemu/7.jpg">
                        </div>
                    ...
                    <div class="proj-names-fonas">
                        ...
                        <div class="contact-form2"><br>
                            <form action="balsavimas.php" method="post" id="balsavimas">
                                <input type="radio" name="vote3" value="1"> 1
                                <input type="radio" name="vote3" value="2"> 2
                                <input type="radio" name="vote3" value="3"> 3 
                                <input type="radio" name="vote3" value="4"> 4
                                <input type="radio" name="vote3" value="5"> 5 <br><br>        
                    ...
                    <div class="proj-names-fonas">
                        ...
                        <div class="contact-form2">
                            <form name="myForm4" action="komentarai.php" method="post" id="komentarai" >
                                <input class="inputas" type="text" name="vardas3" placeholder=" Jūsų vardas" maxlength="50" required value="" > <br>
                                <textarea  class="textarea1" name="komentaras3" rows="8" cols="80" placeholder=" Jūsų komentaras" required></textarea> <br>
                                <input class="siusti inputas" type="submit" name="" value="SIŲSTI">
                            </form>
                        </div>
